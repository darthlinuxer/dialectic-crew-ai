...
def build_task_context(
    ...
    lines = [
        ...
        "## Definition of done",
        "",
        "The task is complete only if the implementation integrates cleanly with the surrounding codebase:",
        "- imports resolve on the touched surface",
        "- related tests or exports are updated when the change requires it",
        "- references and package/module boundaries remain coherent",
        "- no obvious static-analysis or editor breakage is left behind in adjacent files",
        "",
