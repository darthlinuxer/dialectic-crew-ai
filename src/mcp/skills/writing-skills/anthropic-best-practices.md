...
> Learn how to write effective Skills that LLM can discover and use successfully.

Good Skills are concise, well-structured, and tested with real usage. This guide provides practical authoring decisions to help you write Skills that LLM can discover and use effectively.
...
The context window is a public good. Your Skill shares the context window with everything else LLM needs to know, including:
...
<img src=" alt="Bundling additional reference files like reference.md and forms.md." data-og-width="2048" width="2048" data-og-height="1327" height="1327" data-path="images/agent-skills-bundling-content.png" data-optimize="true" data-opv="3" srcset=" 280w,  560w,  840w,  1100w,  1650w,  2500w" />
...
<CardGroup cols={2}>
  <Card title="Get started with Agent Skills" icon="rocket" href="
    Create your first Skill
  </Card>

  <Card title="Use Skills in Claude Code" icon="terminal" href="
    Create and manage Skills in Claude Code
  </Card>

  <Card title="Use Skills with the API" icon="code" href="
