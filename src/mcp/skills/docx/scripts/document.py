...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Darth Linuxer", initials: str = "C"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Darth Linuxer")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Darth Linuxer")
