...
- **Tracked changes**: Use `<w:del>` and `<w:ins>` tags with `w:author="darthlinuxer"` outside `<w:r>` elements
...
```xml
<Relationship Id="rId1" Type=" Target="numbering.xml"/>
<Relationship Id="rId5" Type=" Target="media/image1.png"/>
```
...
rels_editor.append_to(rels_editor.dom.documentElement,
    f'<Relationship Id="{next_rid}" Type=" Target="media/image1.png"/>')
...
### Validation Rules
The validator checks that the document text matches the original after reverting llm's changes. This means:
...
**Text Insertion:**
```xml
<w:ins w:id="1" w:author="darthlinuxer" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
**Text Deletion:**
```xml
<w:del w:id="2" w:author="darthlinuxer" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
<w:ins w:author="Jane Smith" w:id="16">
  <w:del w:author="darthlinuxer" w:id="40">
    <w:r><w:delText>monthly</w:delText></w:r>
  </w:del>
</w:ins>
<w:ins w:author="darthlinuxer" w:id="41">
...
<w:ins w:author="darthlinuxer" w:id="51">
