...
class DrawerManager {
  ...
  renderConditionTree(condition, depth = 0) {
    ...
    if (condition.type === "AND" || condition.type === "OR") {
      ...
      const color = conditionType === "AND" ? "#FF5A50" : "var(--text-secondary)";
      ...
      if (stringChildren.length > 0) {
        ...
        children += grouped.map((group) => {
          if (group.items.length === 1) {
            ...
            const groupId = group.items.join(',');
            const groupColor = conditionType === "AND" ? "#FF5A50" : "var(--text-secondary)";
  ...
  renderMetadata(metadata) {
    ...
    if (metadata.condition_type) {
      const conditionColors = {
        AND: { color: "#FF5A50", bg: "rgba(255,90,80,0.12)" },
        IF: { color: "#FF5A50", bg: "rgba(255,90,80,0.18)" },
        default: { color: "#666666", bg: "rgba(102,102,102,0.12)" },
      };
    ...
    if (metadata.router_paths && metadata.router_paths.length > 0) {
      ...
      metadataContent += `
                <div class="drawer-section">
                    ...
                    <ul class="drawer-list">
                        ${uniqueRouterPaths.map((p) => `<li><span class="drawer-code-link" data-node-id="${p}" style="color: #FF5A50; border-color: rgba(255,90,80,0.3);">${p}</span></li>`).join("")}
                    </ul>
                </div>
            `;
    }
...
class NetworkManager {
  ...
  async initialize() {
    try {
      ...
      this.nodes = new vis.DataSet([{"id": "evaluate_dialectic", "label": "evaluate_dialectic", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">evaluate_dialectic</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">router</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">run_dialectic</code></li></ul>\n                </div>\n            \n                <div>\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Router Paths</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">mark_failed</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">verify</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 1, "nodeStyle": {"name": "evaluate_dialectic", "bgColor": "var(--node-bg-router)", "borderColor": "#FF5A50", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "evaluate_reimplement", "label": "evaluate_reimplement", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">evaluate_reimplement</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">router</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">independent_reimplement</code></li></ul>\n                </div>\n            \n                <div>\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Router Paths</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">mark_failed</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">mark_completed</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 5, "nodeStyle": {"name": "evaluate_reimplement", "bgColor": "var(--node-bg-router)", "borderColor": "#FF5A50", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "evaluate_verification", "label": "evaluate_verification", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">evaluate_verification</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">router</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">verify_implementation</code></li></ul>\n                </div>\n            \n                <div>\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Router Paths</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">reimplement</code></li><li style=\"margin: 3px 0;\"><code style=\"background: rgba(255,90,80,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #FF5A50; border: 1px solid rgba(255,90,80,0.2); font-weight: 600;\">mark_completed</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 3, "nodeStyle": {"name": "evaluate_verification", "bgColor": "var(--node-bg-router)", "borderColor": "#FF5A50", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "independent_reimplement", "label": "independent_reimplement", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">independent_reimplement</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">reimplement</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 4, "nodeStyle": {"name": "independent_reimplement", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "on_completed", "label": "on_completed", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">on_completed</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">mark_completed</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 4, "nodeStyle": {"name": "on_completed", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "on_failed", "label": "on_failed", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">on_failed</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">mark_failed</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 2, "nodeStyle": {"name": "on_failed", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "run_dialectic", "label": "run_dialectic", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">run_dialectic</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">start</span>\n            </div>\n        ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "run_dialectic", "bgColor": "var(--node-bg-start)", "borderColor": "var(--node-border-start)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "verify_implementation", "label": "verify_implementation", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">verify_implementation</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">verify</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 2, "nodeStyle": {"name": "verify_implementation", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}]);
      this.edges = new vis.DataSet([{"from": "run_dialectic", "to": "evaluate_dialectic", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "independent_reimplement", "to": "evaluate_reimplement", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "verify_implementation", "to": "evaluate_verification", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "evaluate_dialectic", "to": "on_failed", "label": "mark_failed", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "evaluate_dialectic", "to": "verify_implementation", "label": "verify", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "evaluate_reimplement", "to": "on_failed", "label": "mark_failed", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "evaluate_reimplement", "to": "on_completed", "label": "mark_completed", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "evaluate_verification", "to": "independent_reimplement", "label": "reimplement", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "evaluate_verification", "to": "on_completed", "label": "mark_completed", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}]);
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"evaluate_dialectic": {"type": "router", "is_router": true, "router_paths": ["mark_failed", "verify"], "trigger_methods": ["run_dialectic"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "evaluate_dialectic", "parameters": {}, "returns": {}}, "source_code": "    @router(run_dialectic)\n    def evaluate_dialectic(self):\n        if self.state.dialectic_success:\n            return \"verify\"\n        return \"mark_failed\"\n", "source_lines": ["    @router(run_dialectic)\n", "    def evaluate_dialectic(self):\n", "        if self.state.dialectic_success:\n", "            return \"verify\"\n", "        return \"mark_failed\"\n"], "source_start_line": 221, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "evaluate_reimplement": {"type": "router", "is_router": true, "router_paths": ["mark_failed", "mark_completed"], "trigger_methods": ["independent_reimplement"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "evaluate_reimplement", "parameters": {}, "returns": {}}, "source_code": "    @router(independent_reimplement)\n    def evaluate_reimplement(self):\n        if self.state.reimplement_success:\n            return \"mark_completed\"\n        return \"mark_failed\"\n", "source_lines": ["    @router(independent_reimplement)\n", "    def evaluate_reimplement(self):\n", "        if self.state.reimplement_success:\n", "            return \"mark_completed\"\n", "        return \"mark_failed\"\n"], "source_start_line": 392, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "evaluate_verification": {"type": "router", "is_router": true, "router_paths": ["reimplement", "mark_completed"], "trigger_methods": ["verify_implementation"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "evaluate_verification", "parameters": {}, "returns": {}}, "source_code": "    @router(verify_implementation)\n    def evaluate_verification(self):\n        if self.state.verified:\n            return \"mark_completed\"\n        return \"reimplement\"\n", "source_lines": ["    @router(verify_implementation)\n", "    def evaluate_verification(self):\n", "        if self.state.verified:\n", "            return \"mark_completed\"\n", "        return \"reimplement\"\n"], "source_start_line": 303, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "independent_reimplement": {"type": "listen", "trigger_methods": ["reimplement"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "independent_reimplement", "parameters": {}, "returns": {}, "summary": "Phase C: Fresh re-implementation by independent agent (no dialectic context)."}, "source_code": "    @listen(\"reimplement\")\n    def independent_reimplement(self):\n        \"\"\"Phase C: Fresh re-implementation by independent agent (no dialectic context).\"\"\"\n        self.state.phases_executed.append(\"reimplement\")\n        print(f\"   {self.state.task_id} starting independent re-implementation (Phase C)...\")\n\n        failed_checks = self.state.verification.checks_failed\n        failed_text = \"\\n\".join(f\"- {c}\" for c in failed_checks) if failed_checks else \"N/A\"\n\n        reimpl_agent = Agent(\n            role=\"Independent Implementer\",\n            goal=\"Fix failed implementation based on checks that did not pass\",\n            backstory=\"You are an implementer focused on fixing specific gaps. \"\n                      \"Read existing files, identify what is missing, and fix it.\",\n            verbose=True,\n            allow_delegation=False,\n            reasoning=True,\n            max_reasoning_attempts=2,\n            llm=implementer.llm,\n            tools=[file_read_tool, file_write_tool],\n        )\n\n        task_fix = Task(\n            description=f\"\"\"\nTask {self.state.task_id} \u2014 {self.state.task_title} was implemented but verification failed.\n\nTASK DESCRIPTION:\n{self.state.task_description}\n\nFAILED CHECKS:\n{failed_text}\n\nVERIFICATION NOTES:\n{self.state.verification.notes[:2000]}\n\nFix ONLY the identified gaps. Use the file reading and writing tools.\n\"\"\",\n            expected_output=\"Description of what was fixed\",\n            agent=reimpl_agent,\n        )\n\n        task_revalidate = Task(\n            description=f\"\"\"\nEvaluate whether the fix for task {self.state.task_id} resolved the issues.\nMinimum score: {self.state.min_score}\n\"\"\",\n            expected_output=\"ValidationOutput\",\n            agent=validador_macro,\n            output_pydantic=ValidationOutput,\n            guardrail=_quality_guardrail,\n            guardrail_max_retries=2,\n            context=[task_fix],\n        )\n\n        crew = Crew(\n            agents=[reimpl_agent, validador_macro],\n            tasks=[task_fix, task_revalidate],\n            process=\"sequential\",\n            verbose=True,\n        )\n\n        result = crew.kickoff()\n\n        validation: ValidationOutput | None = None\n        tasks_out = getattr(result, \"tasks_output\", None) or []\n        if tasks_out:\n            last_p = getattr(tasks_out[-1], \"pydantic\", None)\n            if isinstance(last_p, ValidationOutput):\n                validation = last_p\n\n        if validation and validation.quality_score >= self.state.min_score:\n            self.state.reimplement_score = validation.quality_score\n            self.state.reimplement_success = True\n            impl_raw = getattr(tasks_out[0], \"raw\", \"\") if tasks_out else \"\"\n            self.state.reimplement_output = impl_raw\n            print(f\"   {self.state.task_id} re-implementation approved ({validation.quality_score}/10)\")\n        else:\n            score = validation.quality_score if validation else 0.0\n            self.state.reimplement_score = score\n            self.state.reimplement_success = False\n            print(f\"   {self.state.task_id} re-implementation failed ({score}/10)\")\n        return \"done\"\n", "source_lines": ["    @listen(\"reimplement\")\n", "    def independent_reimplement(self):\n", "        \"\"\"Phase C: Fresh re-implementation by independent agent (no dialectic context).\"\"\"\n", "        self.state.phases_executed.append(\"reimplement\")\n", "        print(f\"   {self.state.task_id} starting independent re-implementation (Phase C)...\")\n", "\n", "        failed_checks = self.state.verification.checks_failed\n", "        failed_text = \"\\n\".join(f\"- {c}\" for c in failed_checks) if failed_checks else \"N/A\"\n", "\n", "        reimpl_agent = Agent(\n", "            role=\"Independent Implementer\",\n", "            goal=\"Fix failed implementation based on checks that did not pass\",\n", "            backstory=\"You are an implementer focused on fixing specific gaps. \"\n", "                      \"Read existing files, identify what is missing, and fix it.\",\n", "            verbose=True,\n", "            allow_delegation=False,\n", "            reasoning=True,\n", "            max_reasoning_attempts=2,\n", "            llm=implementer.llm,\n", "            tools=[file_read_tool, file_write_tool],\n", "        )\n", "\n", "        task_fix = Task(\n", "            description=f\"\"\"\n", "Task {self.state.task_id} \u2014 {self.state.task_title} was implemented but verification failed.\n", "\n", "TASK DESCRIPTION:\n", "{self.state.task_description}\n", "\n", "FAILED CHECKS:\n", "{failed_text}\n", "\n", "VERIFICATION NOTES:\n", "{self.state.verification.notes[:2000]}\n", "\n", "Fix ONLY the identified gaps. Use the file reading and writing tools.\n", "\"\"\",\n", "            expected_output=\"Description of what was fixed\",\n", "            agent=reimpl_agent,\n", "        )\n", "\n", "        task_revalidate = Task(\n", "            description=f\"\"\"\n", "Evaluate whether the fix for task {self.state.task_id} resolved the issues.\n", "Minimum score: {self.state.min_score}\n", "\"\"\",\n", "            expected_output=\"ValidationOutput\",\n", "            agent=validador_macro,\n", "            output_pydantic=ValidationOutput,\n", "            guardrail=_quality_guardrail,\n", "            guardrail_max_retries=2,\n", "            context=[task_fix],\n", "        )\n", "\n", "        crew = Crew(\n", "            agents=[reimpl_agent, validador_macro],\n", "            tasks=[task_fix, task_revalidate],\n", "            process=\"sequential\",\n", "            verbose=True,\n", "        )\n", "\n", "        result = crew.kickoff()\n", "\n", "        validation: ValidationOutput | None = None\n", "        tasks_out = getattr(result, \"tasks_output\", None) or []\n", "        if tasks_out:\n", "            last_p = getattr(tasks_out[-1], \"pydantic\", None)\n", "            if isinstance(last_p, ValidationOutput):\n", "                validation = last_p\n", "\n", "        if validation and validation.quality_score >= self.state.min_score:\n", "            self.state.reimplement_score = validation.quality_score\n", "            self.state.reimplement_success = True\n", "            impl_raw = getattr(tasks_out[0], \"raw\", \"\") if tasks_out else \"\"\n", "            self.state.reimplement_output = impl_raw\n", "            print(f\"   {self.state.task_id} re-implementation approved ({validation.quality_score}/10)\")\n", "        else:\n", "            score = validation.quality_score if validation else 0.0\n", "            self.state.reimplement_score = score\n", "            self.state.reimplement_success = False\n", "            print(f\"   {self.state.task_id} re-implementation failed ({score}/10)\")\n", "        return \"done\"\n"], "source_start_line": 309, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "on_completed": {"type": "listen", "trigger_methods": ["mark_completed"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "on_completed", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"mark_completed\")\n    def on_completed(self):\n        phases = \" \u2192 \".join(self.state.phases_executed)\n        print(f\"   {self.state.task_id} COMPLETED (phases: {phases})\")\n        return self._build_result(success=True)\n", "source_lines": ["    @listen(\"mark_completed\")\n", "    def on_completed(self):\n", "        phases = \" \u2192 \".join(self.state.phases_executed)\n", "        print(f\"   {self.state.task_id} COMPLETED (phases: {phases})\")\n", "        return self._build_result(success=True)\n"], "source_start_line": 398, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "on_failed": {"type": "listen", "trigger_methods": ["mark_failed"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "on_failed", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"mark_failed\")\n    def on_failed(self):\n        phases = \" \u2192 \".join(self.state.phases_executed)\n        print(f\"   {self.state.task_id} FAILED (phases: {phases})\")\n        return self._build_result(success=False)\n", "source_lines": ["    @listen(\"mark_failed\")\n", "    def on_failed(self):\n", "        phases = \" \u2192 \".join(self.state.phases_executed)\n", "        print(f\"   {self.state.task_id} FAILED (phases: {phases})\")\n", "        return self._build_result(success=False)\n"], "source_start_line": 404, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "run_dialectic": {"type": "start", "method_signature": {"operationId": "run_dialectic", "parameters": {}, "returns": {}, "summary": "Phase 0: Full dialectic cycle with retries."}, "source_code": "    @start()\n    def run_dialectic(self):\n        \"\"\"Phase 0: Full dialectic cycle with retries.\"\"\"\n        self.state.phases_executed.append(\"dialectic\")\n        synthesis_for_retry: str | None = None\n\n        for retry in range(self.state.max_retries + 1):\n            if synthesis_for_retry is None:\n                tese_input = f\"\"\"\nTASK TO IMPLEMENT: {self.state.task_id} \u2014 {self.state.task_title}\n\n{self.state.task_description}\n\nCONTEXT:\n{self.state.context_str}\n\nVISION.md (read before implementing):\n{self.state.vision_content[:4000]}\n\"\"\"\n            else:\n                tese_input = f\"\"\"\nRETRY {retry}/{self.state.max_retries} \u2014 Incorporate ALL refinements below.\n\nTASK: {self.state.task_id} \u2014 {self.state.task_title}\n\nCRITIQUES AND REFINEMENTS:\n{synthesis_for_retry[:3000]}\n\nRe-implement incorporating these refinements.\n\"\"\"\n\n            task_impl = Task(\n                description=tese_input,\n                expected_output=\"Description of what was implemented and files created/modified\",\n                agent=implementer,\n            )\n            task_critica = Task(\n                description=f\"\"\"\nAnalyze the implementation of task {self.state.task_id} \u2014 {self.state.task_title}.\nSCOPE: Evaluate ONLY whether it meets the description: \\\"\\\"\\\"{self.state.task_description}\\\"\\\"\\\"\nDo NOT critique outside the scope. Do NOT request additional features.\n\"\"\",\n                expected_output=\"Detailed critique of the implementation\",\n                agent=critico_socratico,\n                context=[task_impl],\n            )\n            task_sintese = Task(\n                description=f\"\"\"\nProduce the SYNTHESIS for task {self.state.task_id}: incorporate ALL critiques.\nInclude clear instructions for retry if necessary.\n\"\"\",\n                expected_output=\"Refined synthesis with instructions\",\n                agent=sintetizador,\n                context=[task_impl, task_critica],\n            )\n            task_val = Task(\n                description=f\"\"\"\nEvaluate the implementation of task {self.state.task_id}.\nMinimum score for approval: {self.state.min_score}\n\"\"\",\n                expected_output=\"ValidationOutput\",\n                agent=validador_macro,\n                output_pydantic=ValidationOutput,\n                guardrail=_quality_guardrail,\n                guardrail_max_retries=2,\n                context=[task_impl, task_critica, task_sintese],\n            )\n\n            crew = Crew(\n                agents=[implementer, critico_socratico, sintetizador, validador_macro],\n                tasks=[task_impl, task_critica, task_sintese, task_val],\n                process=\"sequential\",\n                verbose=True,\n            )\n\n            result = crew.kickoff()\n\n            validation: ValidationOutput | None = None\n            tasks_out = getattr(result, \"tasks_output\", None) or []\n            if tasks_out:\n                last_p = getattr(tasks_out[-1], \"pydantic\", None)\n                if isinstance(last_p, ValidationOutput):\n                    validation = last_p\n\n            score = validation.quality_score if validation else 5.0\n            notes = validation.final_validation_notes if validation else \"No structured output\"\n\n            impl_raw = \"\"\n            if tasks_out and len(tasks_out) >= 1:\n                impl_raw = getattr(tasks_out[0], \"raw\", \"\") or \"\"\n\n            if score >= self.state.min_score:\n                self.state.dialectic_score = score\n                self.state.dialectic_notes = notes\n                self.state.dialectic_success = True\n                self.state.dialectic_retries = retry\n                self.state.impl_output = impl_raw\n                print(f\"   {self.state.task_id} dialectic approved (score {score}/10)\")\n                return \"passed\"\n\n            if tasks_out and len(tasks_out) >= 3:\n                synthesis_for_retry = getattr(tasks_out[2], \"raw\", \"\") or \"\"\n            else:\n                synthesis_for_retry = notes\n\n            if retry < self.state.max_retries:\n                print(f\"   {self.state.task_id} rejected (score {score}/10), retry {retry + 1}\")\n\n        self.state.dialectic_score = score\n        self.state.dialectic_notes = notes\n        self.state.dialectic_success = False\n        self.state.dialectic_retries = self.state.max_retries\n        print(f\"   {self.state.task_id} dialectic failed ({score}/10)\")\n        return \"failed\"\n", "source_lines": ["    @start()\n", "    def run_dialectic(self):\n", "        \"\"\"Phase 0: Full dialectic cycle with retries.\"\"\"\n", "        self.state.phases_executed.append(\"dialectic\")\n", "        synthesis_for_retry: str | None = None\n", "\n", "        for retry in range(self.state.max_retries + 1):\n", "            if synthesis_for_retry is None:\n", "                tese_input = f\"\"\"\n", "TASK TO IMPLEMENT: {self.state.task_id} \u2014 {self.state.task_title}\n", "\n", "{self.state.task_description}\n", "\n", "CONTEXT:\n", "{self.state.context_str}\n", "\n", "VISION.md (read before implementing):\n", "{self.state.vision_content[:4000]}\n", "\"\"\"\n", "            else:\n", "                tese_input = f\"\"\"\n", "RETRY {retry}/{self.state.max_retries} \u2014 Incorporate ALL refinements below.\n", "\n", "TASK: {self.state.task_id} \u2014 {self.state.task_title}\n", "\n", "CRITIQUES AND REFINEMENTS:\n", "{synthesis_for_retry[:3000]}\n", "\n", "Re-implement incorporating these refinements.\n", "\"\"\"\n", "\n", "            task_impl = Task(\n", "                description=tese_input,\n", "                expected_output=\"Description of what was implemented and files created/modified\",\n", "                agent=implementer,\n", "            )\n", "            task_critica = Task(\n", "                description=f\"\"\"\n", "Analyze the implementation of task {self.state.task_id} \u2014 {self.state.task_title}.\n", "SCOPE: Evaluate ONLY whether it meets the description: \\\"\\\"\\\"{self.state.task_description}\\\"\\\"\\\"\n", "Do NOT critique outside the scope. Do NOT request additional features.\n", "\"\"\",\n", "                expected_output=\"Detailed critique of the implementation\",\n", "                agent=critico_socratico,\n", "                context=[task_impl],\n", "            )\n", "            task_sintese = Task(\n", "                description=f\"\"\"\n", "Produce the SYNTHESIS for task {self.state.task_id}: incorporate ALL critiques.\n", "Include clear instructions for retry if necessary.\n", "\"\"\",\n", "                expected_output=\"Refined synthesis with instructions\",\n", "                agent=sintetizador,\n", "                context=[task_impl, task_critica],\n", "            )\n", "            task_val = Task(\n", "                description=f\"\"\"\n", "Evaluate the implementation of task {self.state.task_id}.\n", "Minimum score for approval: {self.state.min_score}\n", "\"\"\",\n", "                expected_output=\"ValidationOutput\",\n", "                agent=validador_macro,\n", "                output_pydantic=ValidationOutput,\n", "                guardrail=_quality_guardrail,\n", "                guardrail_max_retries=2,\n", "                context=[task_impl, task_critica, task_sintese],\n", "            )\n", "\n", "            crew = Crew(\n", "                agents=[implementer, critico_socratico, sintetizador, validador_macro],\n", "                tasks=[task_impl, task_critica, task_sintese, task_val],\n", "                process=\"sequential\",\n", "                verbose=True,\n", "            )\n", "\n", "            result = crew.kickoff()\n", "\n", "            validation: ValidationOutput | None = None\n", "            tasks_out = getattr(result, \"tasks_output\", None) or []\n", "            if tasks_out:\n", "                last_p = getattr(tasks_out[-1], \"pydantic\", None)\n", "                if isinstance(last_p, ValidationOutput):\n", "                    validation = last_p\n", "\n", "            score = validation.quality_score if validation else 5.0\n", "            notes = validation.final_validation_notes if validation else \"No structured output\"\n", "\n", "            impl_raw = \"\"\n", "            if tasks_out and len(tasks_out) >= 1:\n", "                impl_raw = getattr(tasks_out[0], \"raw\", \"\") or \"\"\n", "\n", "            if score >= self.state.min_score:\n", "                self.state.dialectic_score = score\n", "                self.state.dialectic_notes = notes\n", "                self.state.dialectic_success = True\n", "                self.state.dialectic_retries = retry\n", "                self.state.impl_output = impl_raw\n", "                print(f\"   {self.state.task_id} dialectic approved (score {score}/10)\")\n", "                return \"passed\"\n", "\n", "            if tasks_out and len(tasks_out) >= 3:\n", "                synthesis_for_retry = getattr(tasks_out[2], \"raw\", \"\") or \"\"\n", "            else:\n", "                synthesis_for_retry = notes\n", "\n", "            if retry < self.state.max_retries:\n", "                print(f\"   {self.state.task_id} rejected (score {score}/10), retry {retry + 1}\")\n", "\n", "        self.state.dialectic_score = score\n", "        self.state.dialectic_notes = notes\n", "        self.state.dialectic_success = False\n", "        self.state.dialectic_retries = self.state.max_retries\n", "        print(f\"   {self.state.task_id} dialectic failed ({score}/10)\")\n", "        return \"failed\"\n"], "source_start_line": 106, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}, "verify_implementation": {"type": "listen", "trigger_methods": ["verify"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "verify_implementation", "parameters": {}, "returns": {}, "summary": "Phase A: Verify artifacts + Phase B: Check acceptance criteria."}, "source_code": "    @listen(\"verify\")\n    def verify_implementation(self):\n        \"\"\"Phase A: Verify artifacts + Phase B: Check acceptance criteria.\"\"\"\n        self.state.phases_executed.append(\"verify\")\n\n        checks_text = \"\"\n        if self.state.acceptance_checks:\n            checks_text = \"\\n\\nACCEPTANCE CHECKS (verify each one):\\n\"\n            checks_text += \"\\n\".join(f\"- {c}\" for c in self.state.acceptance_checks)\n\n        verify_agent = Agent(\n            role=\"Independent Verifier\",\n            goal=\"Verify whether implementation artifacts exist in the codebase\",\n            backstory=\"You verify implementations by reading actual project files. \"\n                      \"Be objective: the artifact either exists or it does not.\",\n            verbose=True,\n            allow_delegation=False,\n            reasoning=True,\n            max_reasoning_attempts=2,\n            llm=validador_macro.llm,\n            tools=[file_read_tool],\n        )\n\n        task_verify = Task(\n            description=f\"\"\"\nVerify whether task {self.state.task_id} \u2014 {self.state.task_title} was implemented.\n\nTASK DESCRIPTION:\n{self.state.task_description}\n\nUse the file reading tool to verify whether the artifacts exist.\nFor each check, verify whether the file/function/config actually exists.\n{checks_text}\n\nFill in:\n- verified: true if ALL essential artifacts exist\n- checks_passed: list of checks that passed\n- checks_failed: list of checks that failed\n- notes: explanation of what was verified\n\"\"\",\n            expected_output=\"VerificationResult\",\n            agent=verify_agent,\n            output_pydantic=VerificationResult,\n            guardrail=_verification_guardrail,\n            guardrail_max_retries=2,\n        )\n\n        crew = Crew(agents=[verify_agent], tasks=[task_verify], verbose=True)\n        result = crew.kickoff()\n\n        vr: VerificationResult | None = None\n        pydantic_result = getattr(result, \"pydantic\", None)\n        if isinstance(pydantic_result, VerificationResult):\n            vr = pydantic_result\n        else:\n            tasks_out = getattr(result, \"tasks_output\", None) or []\n            if tasks_out:\n                last_p = getattr(tasks_out[-1], \"pydantic\", None)\n                if isinstance(last_p, VerificationResult):\n                    vr = last_p\n\n        if vr:\n            self.state.verified = vr.verified\n            self.state.verification = vr\n        else:\n            self.state.verified = False\n            self.state.verification = VerificationResult(\n                verified=False, notes=\"Failed to obtain structured VerificationResult\"\n            )\n\n        status = \"PASSED\" if self.state.verified else \"FAILED\"\n        print(f\"   {self.state.task_id} verification: {status}\")\n        if self.state.verification.checks_failed:\n            print(f\"      Failed checks: {self.state.verification.checks_failed}\")\n        return \"done\"\n", "source_lines": ["    @listen(\"verify\")\n", "    def verify_implementation(self):\n", "        \"\"\"Phase A: Verify artifacts + Phase B: Check acceptance criteria.\"\"\"\n", "        self.state.phases_executed.append(\"verify\")\n", "\n", "        checks_text = \"\"\n", "        if self.state.acceptance_checks:\n", "            checks_text = \"\\n\\nACCEPTANCE CHECKS (verify each one):\\n\"\n", "            checks_text += \"\\n\".join(f\"- {c}\" for c in self.state.acceptance_checks)\n", "\n", "        verify_agent = Agent(\n", "            role=\"Independent Verifier\",\n", "            goal=\"Verify whether implementation artifacts exist in the codebase\",\n", "            backstory=\"You verify implementations by reading actual project files. \"\n", "                      \"Be objective: the artifact either exists or it does not.\",\n", "            verbose=True,\n", "            allow_delegation=False,\n", "            reasoning=True,\n", "            max_reasoning_attempts=2,\n", "            llm=validador_macro.llm,\n", "            tools=[file_read_tool],\n", "        )\n", "\n", "        task_verify = Task(\n", "            description=f\"\"\"\n", "Verify whether task {self.state.task_id} \u2014 {self.state.task_title} was implemented.\n", "\n", "TASK DESCRIPTION:\n", "{self.state.task_description}\n", "\n", "Use the file reading tool to verify whether the artifacts exist.\n", "For each check, verify whether the file/function/config actually exists.\n", "{checks_text}\n", "\n", "Fill in:\n", "- verified: true if ALL essential artifacts exist\n", "- checks_passed: list of checks that passed\n", "- checks_failed: list of checks that failed\n", "- notes: explanation of what was verified\n", "\"\"\",\n", "            expected_output=\"VerificationResult\",\n", "            agent=verify_agent,\n", "            output_pydantic=VerificationResult,\n", "            guardrail=_verification_guardrail,\n", "            guardrail_max_retries=2,\n", "        )\n", "\n", "        crew = Crew(agents=[verify_agent], tasks=[task_verify], verbose=True)\n", "        result = crew.kickoff()\n", "\n", "        vr: VerificationResult | None = None\n", "        pydantic_result = getattr(result, \"pydantic\", None)\n", "        if isinstance(pydantic_result, VerificationResult):\n", "            vr = pydantic_result\n", "        else:\n", "            tasks_out = getattr(result, \"tasks_output\", None) or []\n", "            if tasks_out:\n", "                last_p = getattr(tasks_out[-1], \"pydantic\", None)\n", "                if isinstance(last_p, VerificationResult):\n", "                    vr = last_p\n", "\n", "        if vr:\n", "            self.state.verified = vr.verified\n", "            self.state.verification = vr\n", "        else:\n", "            self.state.verified = False\n", "            self.state.verification = VerificationResult(\n", "                verified=False, notes=\"Failed to obtain structured VerificationResult\"\n", "            )\n", "\n", "        status = \"PASSED\" if self.state.verified else \"FAILED\"\n", "        print(f\"   {self.state.task_id} verification: {status}\")\n", "        if self.state.verification.checks_failed:\n", "            print(f\"      Failed checks: {self.state.verification.checks_failed}\")\n", "        return \"done\"\n"], "source_start_line": 227, "source_file": "/home/darthlinuxer/dialectic-crew-ai/src/execution/task_flow.py", "class_signature": "class TaskExecutionFlow(Flow[TaskFlowState])", "class_line_number": 98, "class_name": "TaskExecutionFlow"}}, "edges": [{"source": "run_dialectic", "target": "evaluate_dialectic", "condition_type": "OR", "is_router_path": false}, {"source": "independent_reimplement", "target": "evaluate_reimplement", "condition_type": "OR", "is_router_path": false}, {"source": "verify_implementation", "target": "evaluate_verification", "condition_type": "OR", "is_router_path": false}, {"source": "evaluate_dialectic", "target": "on_failed", "condition_type": null, "is_router_path": true, "router_path_label": "mark_failed"}, {"source": "evaluate_dialectic", "target": "verify_implementation", "condition_type": null, "is_router_path": true, "router_path_label": "verify"}, {"source": "evaluate_reimplement", "target": "on_failed", "condition_type": null, "is_router_path": true, "router_path_label": "mark_failed"}, {"source": "evaluate_reimplement", "target": "on_completed", "condition_type": null, "is_router_path": true, "router_path_label": "mark_completed"}, {"source": "evaluate_verification", "target": "independent_reimplement", "condition_type": null, "is_router_path": true, "router_path_label": "reimplement"}, {"source": "evaluate_verification", "target": "on_completed", "condition_type": null, "is_router_path": true, "router_path_label": "mark_completed"}], "start_methods": ["run_dialectic"], "router_methods": ["evaluate_dialectic", "evaluate_reimplement", "evaluate_verification"]};
